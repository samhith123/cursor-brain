...
3. **MCP server (for AI to use memory)**
   ...
   - Example config: see [docs/setup.md](https://github.com/samhith123/cursor-brain/blob/HEAD/docs/setup.md).
...
See [docs/usage.md](https://github.com/samhith123/cursor-brain/blob/HEAD/docs/usage.md) for a short walkthrough.

## Docs

- [docs/setup.md](https://github.com/samhith123/cursor-brain/blob/HEAD/docs/setup.md) – Step-by-step setup and env vars.
- [docs/usage.md](https://github.com/samhith123/cursor-brain/blob/HEAD/docs/usage.md) – Example flows and MCP tool usage.

## License

MIT License. See [LICENSE](https://github.com/samhith123/cursor-brain/blob/HEAD/LICENSE) for details. Copyright (c) 2026 Samhith Gardas.
