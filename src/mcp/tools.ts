...
const MEMORY_TYPES = ["session_memory", "long_term_memory", "project_memory"] as const;
...
export function listTools(): { name: string; description: string; inputSchema: object }[] {
  return [
    {
      name: "memory.search",
